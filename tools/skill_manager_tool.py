...
SKILL_MANAGE_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            # and staged-write replay depend on it. The fork ADVERTISES that
            # shape (and absorbed_into/reason) below because its admission
            # gate requires the model to supply `reason` on create/edit/patch.
            "name": {
                "type": "string",
                "description": (

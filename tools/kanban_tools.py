    ...
    "parameters": {
        ...
        "properties": {
            ...
            "model": {
                "type": "string",
                "description": (
                    "Worker model override. Use the provider's exact model "
                    "name; omit for the assignee profile default."
                ),
            },
            "provider": {
                "type": "string",
                "description": (
                    "Provider for model (for example openrouter or anthropic). "
                    "Requires model; omit for the assignee profile provider."
                ),
            },
            "board": _board_schema_prop(),
        },

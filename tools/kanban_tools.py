...
KANBAN_REQUEST_REVIEW_SCHEMA = {
    ...
    "description": (
        "Submit verified work for review without marking the task blocked. "
        "Moves it to review and notifies the subscriber."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "summary": {
                "type": "string",
                "description": "Concise implementation and verification handoff.",
            },
            "reviewer": {
                "type": "string",
                "description": "Optional reviewer profile.",
            },
            "metadata": {
                "type": "object",
                "description": "Optional structured review facts.",
...
KANBAN_REQUEST_CHANGES_SCHEMA = {
    ...
    "description": (
        "Return a review task to its implementer with required changes, "
        "without using blocker-loop accounting."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "reason": {
                "type": "string",
                "description": "Specific actionable changes required.",
            },
            "board": _board_schema_prop(),
        },
        "required": ["reason"],
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "workspace_kind": {
                ...
                "description": "scratch, shared dir, or git worktree.",
            },
            "workspace_path": {
                "type": "string",
                "description": "Absolute dir/worktree path.",
            },
            "project": {
                "type": "string",
                "description": "Project id for a deterministic worktree.",
            },
            "triage": {
                "type": "boolean",
            },
            "idempotency_key": {
                "type": "string",
                "description": "Retry key for idempotent creation.",
            },
            "correction": {
                "type": "object",
                "additionalProperties": False,
                "description": "Stable correction identity; excludes idempotency_key.",
                "properties": {
            ...
            "initial_status": {
                ...
                "description": "running, or blocked for an immediate human gate.",
            },
            "skills": {
                "type": "array",
                "items": {"type": "string"},
            ...
            "provider": {
                "type": "string",
                "description": "Provider override; requires model.",
            },
            "board": _board_schema_prop(),
        },

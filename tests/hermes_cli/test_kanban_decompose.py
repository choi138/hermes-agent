...
def test_decompose_policy_recommends_direct_for_single_owner_sync_work():
    prompt = decomp._SYSTEM_PROMPT.lower()

    assert "one-owner synchronous deterministic work" in prompt
    assert "durability, waiting, approval, or independent-role" in prompt

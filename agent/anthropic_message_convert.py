...
def _get_signature_passthrough_urls() -> frozenset:
    ...
    (Lives here rather than in ``anthropic_endpoints`` because that module's
    contract is pure URL predicates with no I/O; this one reads config.)
    """
...
def _is_signature_passthrough_endpoint(base_url) -> bool:

...
KANBAN_GUIDANCE = (
    ...
    "3. **Heartbeat on long operations.** Short tasks need only their automatic "
    "start and final events. For longer work, call `kanban_heartbeat(note=...)` "
    "only at a meaningful milestone or after a long quiet period; make the note "
    "role-specific and evidence-based. Never invent percentages or report "
    "unverified success. **If your task may run longer than 1 hour, "

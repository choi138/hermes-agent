...
# Fork keeps the legacy standalone constants alongside the builder:
# system_prompt.py still injects MEMORY_GUIDANCE per-store and NOTES_GUIDANCE
# for the curated notes tier (notes_write/notes_read are fork-only tools).
MEMORY_GUIDANCE = (

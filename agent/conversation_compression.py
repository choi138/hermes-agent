...
def compress_context(
    ...
    *,
    ...
    try:
        ...
        # Ingest-disabled forks (ADR-004 Phase 0) must not trigger provider
        # extraction from their harness transcript. checkpoint_required is
        # exempt: the operator explicitly demanded a checkpoint before any
        # lossy rewrite, and hygiene/fork paths never set that flag.
